...
data = [
    {"Task": "攻击面--easm", "status": "coding",  "Start": "2025-01-20", "End": "2025-02-15", "Completion": 0.2, },

    {"Task": "资产接入--asset_sync", "status": "finish",  "Start": "2025-01-20", "End": "2025-02-10", "Completion": 1,},

    {"Task": "暗网信息泄漏--dark",  "status": "coding", "Start": "2025-01-10", "End": "2025-03-10", "Completion": 0.1,},

    {"Task": "互联网监测--internet_monitor",  "status": "no_started", "Start": "2025-03-21", "End": "2025-03-28", "Completion": 0,},

    {"Task": "钓鱼工具--phish_tool", "status": "coding", "Start": "2025-01-10", "End": "2025-03-10",
     "Completion": 0.2, },

    {"Task": "漏管平台--vuln_module", "status": "coding", "Start": "2025-02-05", "End": "2025-04-10",
     "Completion": 0.3, },

    {"Task": "数据服务--dataService", "status": "finish", "Start": "2025-01-15", "End": "2025-03-15",
     "Completion": 0.8, },

    {"Task": "互联网风险扫描工具--goby", "status": "coding", "Start": "2025-01-24", "End": "2025-02-10",
     "Completion": 0.5, },

    {"Task": "互联网资产排查工具--intenet_easm_tool", "status": "coding", "Start": "2025-03-10", "End": "2025-04-22",
     "Completion": 0.5, },
...
y_positions = np.arange(0, len(data) * 1, 3)  # 步长为2，间隔增大
ax.set_yticks(y_positions)
# ax.set_yticklabels([data.get('Task')])
...
# 画布标题
plt.suptitle('2025 work schedule', color='w')
...
ax1.set_yticks([])
# plt.show()
plt.savefig('tet.png', facecolor='#36454F')